...
class GUIController:
    ...
    === Attributes ===
    @param float cheese_scale:لتحديد إرتفاع كل طابق من طوابق ال tower
        cheese height
    @param root tk.Tk: لتحديد حجم النافذة للعبة
    """
    ...
    def __init__(self, number_of_cheeses, number_of_stools, content_width,
        ...
        @param int number_of_cheeses:عدد الطوابق فى البرج
            
        @param int number_of_stools:
            عدد الاماكن اللتى يتحرك عليها البرج
        @param float content_width:
            حجم المساحة اللتى تعمل بها اللعبة
        @param float content_height:
           الإرتفاع للمساحة بتاع اللعية
        @param float cheese_scale:
           حجم كل طابق من الطوابق
        """
